...
1. adicionar persistencia local com `localStorage`
2. criar tela mais detalhada por condominio
3. criar regua de cobranca simples
4. preparar publicacao definitiva na `Vercel`
5. depois iniciar backend e integracoes reais
